...
public class Pengurangan extends Level {
    ...
    // Level Pengurangan.
    public static void soalPengurangan(Login player){
  
        player.setLive(3);
        player.setSkor(0);

        // Masuk ke tampilan Menu Penjumlahan.
        tampilan.tampilanPengurangan();
        ...
        while((player.getSkor() < 300) && (player.getLive() > 0) ) {
            ...
            while (true) {
                try {
                    ...
                    // variabel 'inputJawaban' Karna inputan awal masih berupa string. maka di ubah
                    // terlebih dahulu menjadi Integer.
                    inputJawaban = Integer.parseInt(tampilan.tampilanPengurangan(Pengurangan.getBil1(), Pengurangan.getBil2()));
        ...
        if (player.getLive() <= 0) {
            ...
            tampilan.tampilanBerhasilPengurangan(player);
            sc.nextLine();
